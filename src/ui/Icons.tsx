...
export const IconNetwork = ({ size = 24, ...props }: IconProps) => (
  <svg {...base(size)} {...props}>
...
export const IconJobs = ({ size = 24, ...props }: IconProps) => (
  <svg {...base(size)} {...props}>
...
export const IconMe = ({ size = 24, ...props }: IconProps) => (
  <svg {...base(size)} {...props}>
...
export const IconRepost = ({ size = 24, ...props }: IconProps) => (
  <svg {...base(size)} {...props}>
...
export const IconSend = ({ size = 24, ...props }: IconProps) => (
  <svg {...base(size)} {...props}>
...
export const IconClipboard = ({ size = 24, ...props }: IconProps) => (
  <svg {...base(size)} {...props}>
...
export const IconGavel = ({ size = 24, ...props }: IconProps) => (
  <svg {...base(size)} {...props}>
...
export const IconTrophy = ({ size = 24, ...props }: IconProps) => (
  <svg {...base(size)} {...props}>
